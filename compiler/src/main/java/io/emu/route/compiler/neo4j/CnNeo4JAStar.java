...
public class CnNeo4JAStar implements PathFinder<WeightedPath> {
	...
	// CostEvaluator<Double> lengthEvaluator, EstimateEvaluator<Double>
	// estimateEvaluator )
	// {
	...
	public WeightedPath findSinglePath(Node start, Node end) {
		...
		while (doer.hasNext()) {
			...
			// 距离限制
			// if( doer.score.get( node.getId() ).wayLength>5000d){
			// return null;
			// }
			if (node.equals(end)) {
				// Hit, return path
