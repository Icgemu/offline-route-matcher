...
public class Server {
    ...
    /**
     * 使用指定的参数启动实例.
     * @param sNeo4jDbPath  Neo4j的数据目录
     * @param sRedisCnnUrl 连接Redis的主机和端口
     * @param iServerPort 监听端口
     */
...
//    }
    ...
    /**
     * 启动监听实例，开始接收请求.
     * @throws TTransportException 连接异常
     * @throws IOException 
     */
    public void start() throws TTransportException, IOException {

    	RouteService.Processor<RouteEst> processor 
            = new RouteService.Processor<RouteEst>(
                new RouteEst());
