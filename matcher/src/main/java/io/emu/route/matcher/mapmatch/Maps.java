...
public class Maps {
	 ...
	 * @throws Exception
	 */
	public static List<List<CandidatePath>> getRoute(List<GPS> trace)
			throws Exception {
		// 设置方位角
	 ...
	 * @throws IOException
	 */
	public static void output(List<List<CandidatePath>> paths, String outfile)
			throws IOException {
	 ...
	 * @throws IOException
	 */
	public static List<String> output(List<List<CandidatePath>> paths)
			throws IOException {
	 ...
	 * @throws IOException
	 */
	public static List<String> output1(List<List<CandidatePath>> paths)
			throws IOException {
		// BufferedWriter bw = new BufferedWriter(new FileWriter(new
		// File(outfile) ));
		List<String> res = new ArrayList<String>();
		...
		for (List<CandidatePath> path : paths) {
			...
			for (CandidatePath p : path) {
				...
				long endT = p.getSt().getGps().getTime()
						+ Math.round((p.getSt().getLink().getLength() - p
								.getSt().getPrjDistanceFormSNode()) / spd);
	...
	public static List<List<CandidatePath>> truncate(
			List<List<CandidatePath>> paths) throws IOException {
		// BufferedWriter bw = new BufferedWriter(new FileWriter(new
		// File(outfile) ));
	...
	private static boolean checkBreak(List<List<CandidatePath>> paths,
	...
	private static List<CandidatePath> getFinalPathFor(
	 ...
	 * @return
	 */
	public static List<CandidatePath> getPaths(List<CandidatePrj> s,
			List<CandidatePrj> e) {
